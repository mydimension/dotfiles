# Generated by Powerlevel10k configuration wizard on 2022-11-10 at 22:29 EST.
...
() {
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=darkgreen
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=148
  ...
  ####################################[ time: current date ]####################################
  # Current date color.
  typeset -g POWERLEVEL9K_DATE_FOREGROUND=darkgreen
  typeset -g POWERLEVEL9K_DATE_BACKGROUND=148
  typeset -g POWERLEVEL9K_DATE_FORMAT="%D{%m/%d}"
  typeset -g POWERLEVEL9K_DATE_UPDATE_ON_COMMAND=true
